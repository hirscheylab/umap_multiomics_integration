...
plot_bio_annotations <- function(data, db) {
  ...
  # data <- data[data$cancer %in% c("breast", "melanoma", "ovarian"), ]
...
# clinical_analysis <- clinical_analysis[clinical_analysis$cancer %in% c("breast", "melanoma", "ovarian"), ]
...
ggsave(paste0(results_folder, "clinical_annotations.pdf"), dpi = 300, width = 8, height = 7) # _sub
```
